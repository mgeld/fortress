...
const battle_take_1 = require("./controllers/battle-take");
...
const vk_user_2 = require("./infra/database/memory/repositories/vk-user");
...
const battle_create_1 = require("./controllers/battle-create");
...
container.bind(types_1.TYPES.BattleTakeHandler).to(battle_take_1.BattleTakeHandler);
container.bind(types_1.TYPES.BattleCreateHandler).to(battle_create_1.BattleCreateHandler);
...
container.bind(types_1.TYPES.ArenaSectorService).to(arena_sector_service_1.ArenaSectorService);
container.bind(types_1.TYPES.VkUserService).to(vk_user_service_1.VkUserService);
...
container.bind(types_1.TYPES.ArenaRepository).to(arena_2.ArenaRepository);
...
container.bind(types_1.TYPES.ArenaSectorMemoryRepository).to(arena_sector_1.ArenaSectorMemoryRepository);
...
container.bind(types_1.TYPES.VkUserMemoryRepository).to(vk_user_2.VkUserMemoryRepository);
...
container.bind(types_1.TYPES.SnapshotAreals).to(snapshot_areals_1.SnapshotAreals);
container.bind(types_1.TYPES.SnapshotArenas).to(snapshot_arenas_1.SnapshotArenas);
container.bind(types_1.TYPES.VkCallback).to(vk_callback_1.VkCallback);
container.bind(types_1.TYPES.connection).toConstantValue(connection_1.default);
container.bind(types_1.TYPES.BattleService).to(battle_service_1.BattleService);
