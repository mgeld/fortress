...
const $sectorsStore = (0, effector_1.createStore)(DEFAULT_STORE)
    ...
    return sectors.map(zoneItem => {
        if (zoneItem.zone.zone_id === setter.prev_zone_id)
            return Object.assign(Object.assign({}, zoneItem), { sectors: zoneItem.sectors.filter(sect_id => {
        ...
        if (zoneItem.zone.zone_id === setter.new_zone_id)
            return Object.assign(Object.assign({}, zoneItem), { sectors: [...zoneItem.sectors, setter.sector] });
        return zoneItem;
    });
});
