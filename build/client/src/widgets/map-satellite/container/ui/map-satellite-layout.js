...
const MapSatelliteLayout = () => {
    ...
    return (<div className='mapCard'>
            ...
            <react_leaflet_1.MapContainer ref={map_1.mapModel.events.setMap} className='_MapContainer' center={zone === null || zone === void 0 ? void 0 : zone.latlng} zoom={12} minZoom={12} maxZoom={17} doubleClickZoom={false} zoomControl={false} maxBounds={bounds} bounceAtZoomLimits={false}>
