...
const _icons_2 = require("../battle-counters/icons/_icons");
const Counters = () => {
    ...
    return (<>
            ...
            <counter_1.Counter width={74} onClick={() => setTooltip(3)} className={styles_module_scss_1.default.__coin} icon={(<_icons_2.IconCoin />)} text={String(zone_1.zoneModel.selectors.useZoneCoins())}>

                {tooltip === 3 ? (<ui_1.Tooltip pos="right" message="Монеты"/>) : <></>}

            </counter_1.Counter>

            <counter_1.Counter width={74} onClick={() => setTooltip(4)} className={styles_module_scss_1.default.__sapphire} icon={<_icons_2.IconSapphire />} text={String(zone_1.zoneModel.selectors.useZoneRubies())}>
