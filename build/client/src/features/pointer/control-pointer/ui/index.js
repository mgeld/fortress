...
const ControlPointer = () => {
    ...
    return (<div className={styles_module_scss_1.default.controlDirections}>
            <div className={styles_module_scss_1.default.__circle}>
                <react_joystick_component_1.Joystick size={74} stickSize={48} sticky={false} baseColor="#ffffff00" stickImage='icons/control_directions.png' minDistance={30} throttle={250} move={moveControl} stop={stopPoint}/>
            </div>
        </div>);
};
