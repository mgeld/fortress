...
let EditZoneHandler = class EditZoneHandler {
    ...
    handle(message, uSocket) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!__name || !__icon || !__color)
                return;
            const zone = yield this._zoneService.getById(USER_ID);
            const pointer = yield this._pointerService.memoryGetById(USER_ID);
            zone.color = __color;
